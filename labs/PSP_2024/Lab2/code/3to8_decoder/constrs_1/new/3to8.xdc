...
set_property PACKAGE_PIN M4 [get_ports in_A2]; 
...
set_property PACKAGE_PIN J4 [get_ports out_Y4]; 
set_property PACKAGE_PIN G3 [get_ports out_Y5]; 
set_property PACKAGE_PIN G4 [get_ports out_Y6]; 
set_property PACKAGE_PIN F6 [get_ports out_Y7]; 
...
set_property IOSTANDARD LVCMOS33 [get_ports out_Y4]; 
set_property IOSTANDARD LVCMOS33 [get_ports out_Y5]; 
set_property IOSTANDARD LVCMOS33 [get_ports out_Y6]; 
set_property IOSTANDARD LVCMOS33 [get_ports out_Y7]; 
